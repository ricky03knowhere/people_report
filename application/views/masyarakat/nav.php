                    ...
                    <div class="col-md-12">
                        <div class="au-breadcrumb-content text-center">
                            ...
                            <button class="au-btn au-btn-icon au-btn--green" data-toggle="modal" data-target="#mediumModal">
                                <i class="zmdi zmdi-plus"></i>kirim pengaduan</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="card bg-primary cont mx-3 mb-4 text-center pb-1" >
             	<i class="fa fa-user-alt fa-3x text-white mt-3 mb-2" ></i><h5><?= $user['telp']; ?></h5>
      </div>
