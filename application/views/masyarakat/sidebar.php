            ...
            <ul class="list-unstyled navbar__list">
                ...
                <li class="has-sub">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        <li>
                            <a href="<?= base_url('index.php/data_pengaduan/0/0/').$msy['nama']; ?>">
                                <i class="fas fa-file-import"></i>Pengaduan </a>
                        </li>
                        <li>
                            <a href="<?= base_url('index.php/data_pengaduan/index/0/terverifikasi/').$msy['nama']; ?>">
                                <i class="fas fa-question-circle"></i>Telah Terverifikasi</a>
                        </li>
                        <li>
                        <a href="<?= base_url('index.php/data_tanggapan/index/0/').$msy['nama']; ?>">
                        <i class="fas fa-check-circle"></i>Telah ditanggapi</a>
                        </li>
                    </ul>
                </li>
